...
const THEMES = {
  ...
  ocean: {
    ...
    vignette: 0.4,
    placeholderFill: "rgba(0,0,0,0.26)",
    placeholderStroke: "rgba(255,255,255,0.16)",
    placeholderText: "rgba(255,255,255,0.22)",
    back: {
      from: "#0f9c8f",
  ...
  violet: {
    ...
    vignette: 0.44,
    placeholderFill: "rgba(0,0,0,0.28)",
    placeholderStroke: "rgba(255,255,255,0.15)",
    placeholderText: "rgba(255,255,255,0.21)",
    back: {
      from: "#8e5cd9",
      to: "#4c2a8f",
      line: "rgba(255,255,255,0.52)",
      lattice: "rgba(255,255,255,0.15)",
      emblem: "✧",
      emblemColor: "rgba(255,255,255,0.92)",
    },
  },
  parchment: {
    name: "parchment",
